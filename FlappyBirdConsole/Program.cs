...
namespace FlappyBirdConsole
{
    class Program
    {
        ...
        public int score, highscore, bodyX, bodyY, height, width, falldelay, wingDelay, raiseSpeed, fallSpeed;
        ...
        public int splitStart, splitLength, pipeBodyX, pipeWidth, r;

        public int[,] pipeX2 = new int[30, 30];
        public int[,] pipeY2 = new int[30, 30];
        public char[,] pipe2 = new char[30, 30];
        public int splitStart2, splitLength2, pipeBodyX2;
        ...
        delegate void DelegateKeyPress(ConsoleKey key);
        event DelegateKeyPress OnKeyPress;

        void DoFly(ConsoleKey key){
                ...
                for (int j = 0; j < width; j++)
                {
                    ...
                    for (int m = 0; m < 3; m++)
                        for (int n = 0; n < 5; n++)
                        {
                            ...
                            {
                                if (j == bodyX + 1 && i == bodyY)
                                {
                                    Console.ForegroundColor = ConsoleColor.White;
                                    Console.Write(bird[m, n]);
                                }
                                else if (j == bodyX - 1 && i == bodyY)
                                {
                                    Console.ForegroundColor = ConsoleColor.Magenta;
                                    Console.Write(bird[m, n]);
                                }
                                else if (j == bodyX + 2 && i == bodyY)
                                {
        ...
        void ViewHelp()
        {
            ...
            Console.WriteLine("                      - DoubleClick to lazy pause the game :D");
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("           -- Press ESC to return to Main Menu --");
            while (true)
        ...
        {
            bird[0, 0] = ' '; birdX[0, 0] = bodyX - 2; birdY[0, 0] = bodyY - 1;
            bird[0, 1] = '='; birdX[0, 1] = bodyX - 1; birdY[0, 1] = bodyY - 1;
            bird[0, 2] = '='; birdX[0, 2] = bodyX; birdY[0, 2] = bodyY - 1;
            bird[0, 3] = '='; birdX[0, 3] = bodyX + 1; birdY[0, 3] = bodyY - 1;
            bird[0, 4] = ' '; birdX[0, 4] = bodyX + 2; birdY[0, 4] = bodyY - 1;

            bird[1, 0] = '='; birdX[1, 0] = bodyX - 2; birdY[1, 0] = bodyY;
            bird[1, 1] = wch; birdX[1, 1] = bodyX - 1; birdY[1, 1] = bodyY; // wing
            bird[1, 2] = '='; birdX[1, 2] = bodyX; birdY[1, 2] = bodyY; // body
            bird[1, 3] = ech; birdX[1, 3] = bodyX + 1; birdY[1, 3] = bodyY; // eye
            bird[1, 4] = '>'; birdX[1, 4] = bodyX + 2; birdY[1, 4] = bodyY; // neb

            bird[2, 0] = ' '; birdX[2, 0] = bodyX - 2; birdY[2, 0] = bodyY + 1;
            bird[2, 1] = '='; birdX[2, 1] = bodyX - 1; birdY[2, 1] = bodyY + 1;
            bird[2, 2] = '='; birdX[2, 2] = bodyX; birdY[2, 2] = bodyY + 1;
            bird[2, 3] = '='; birdX[2, 3] = bodyX + 1; birdY[2, 3] = bodyY + 1;
            bird[2, 4] = ' '; birdX[2, 4] = bodyX + 2; birdY[2, 4] = bodyY + 1;
        }
        ...
        void SetPipeInfo()
        {
            for (int i = 0; i < height; i++)
            {
                ...
                {
                    if (j < r)
                        pipeX[i, j] = pipeBodyX - (r - j);
                    else if (j > r)
                        pipeX[i, j] = pipeBodyX + (j - r);
                    else if (j == r)
                        pipeX[i, j] = pipeBodyX;
        ...
        void SetPipe2Info()
        {
            for (int i = 0; i < height; i++)
            {
                ...
                {
                    if (j < r)
                        pipeX2[i, j] = pipeBodyX2 - (r - j);
                    else if (j > r)
                        pipeX2[i, j] = pipeBodyX2 + (j - r);
                    else if (j == r)
                        pipeX2[i, j] = pipeBodyX2;
        ...
        void DeadCheck()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                for (int j = 0; j < 5; j++)
                {
                    ...
                    {
                        if (birdX[i, j] >= pipeBodyX - r && birdX[i, j] <= pipeBodyX + r - 1)
                        {
                            SetBirdInfo(wing, 'x');
                            Render();
                            gameOver = true;
                    ...
                    {
                        if (birdX[i, j] >= pipeBodyX2 - r && birdX[i, j] <= pipeBodyX2 + r + 1)
                        {
                            SetBirdInfo(wing, 'x');
                            Render();
                            gameOver = true;
        ...
        void Setup()
        {
            ...
            pipeBodyX = 60;
            pipeBodyX2 = pipeBodyX + pipeWidth + 21;
            pipeWidth = 17;
            r = pipeWidth / 2;
        }
        ...
        void Logic()
        {
            ...
            if (pipeBodyX == bodyX - r || pipeBodyX2 == bodyX - r)
            {
                score++;
                if (score > highscore)
                {
